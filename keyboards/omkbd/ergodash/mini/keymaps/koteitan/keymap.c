...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+      +------+------+------+      +------+------+------+------+-------------|
   * | Alt  |  GUI | EISU |    lower    |  TAB | SPC    SPC  ||||||||  BS     BS  | Enter|    RAISE    | Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT(
    ...
    KC_LALT,  KC_LGUI, EISU,    LOWER,        KC_TAB,  KC_SPC, KC_SPC,        KC_BSPC, KC_BSPC, KC_ENT,      RAISE,       KC_LEFT, KC_DOWN, KC_RGHT
  ),
   ...
   * |-------------+------+------+------+------+      +------+------+------+      +------+------+------+------+-------------|
   * | Alt  |  F11 |  F12 |    lower    |  TAB | SPC    SPC  ||||||||  BS     BS  | Enter|    RAISE    | Home |PageDn|  End |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_LOWER] = LAYOUT(
    ...
    KC_LALT, KC_F11,  KC_F12,      LOWER,        KC_TAB,  KC_SPC, KC_SPC,        KC_BSPC, KC_BSPC, KC_ENT,      RAISE,         KC_HOME, KC_PGDN, KC_END
  ),
