...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  | SPC  |                    |  BS  |   N  |   M  |   ,  |   .  |  Up  |  /   |
   * |-------------+------+------+------+------+      +------+------+------+      +------+------+------+------+-------------|
   * | Alt  |  GUI | lower|    IME      |  TAB | SPC    SPC  ||||||||  BS     BS  | Enter|    RAISE    | Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT(
    ...
    KC_LALT, KC_LGUI, LOWER,        IME,         KC_TAB,  KC_SPC, KC_SPC,        KC_BSPC, KC_BSPC, KC_ENT,      RAISE,       KC_LEFT, KC_DOWN, KC_RGHT
  ),
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   F6 |   F7 |   F8 |   F9 |  F10 | SPC  |                    |  BS  |   N  |   M  |   <  |   >  |PageUp|  ?   | 
   * |-------------+------+------+------+------+      +------+------+------+      +------+------+------+------+-------------|
   * | Alt  |  GUI | lower|     IME     |  TAB | SPC    SPC  ||||||||  BS     BS  | Enter|    RAISE    | Home |PageDn|  End |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_LOWER] = LAYOUT(
    ...
    KC_LSFT, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_SPC,                         KC_BSPC, KC_N,    KC_M,    KC_LT,   KC_GT,   KC_PGUP, KC_QUES,
    KC_LALT, KC_LGUI, LOWER,        IME,         KC_TAB,  KC_SPC, KC_SPC,        KC_BSPC, KC_BSPC, KC_ENT,      RAISE,         KC_HOME, KC_PGDN, KC_END
  ),
  ...
  * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
  * | Shift|   6  |   7  |   8  |   9  |   0  | SPC  |                    |  BS  |   N  |   M  |   <  |   >  |PageUp|  ?   |
  * |-------------+------+------+------+------+      +------+------+------+      +------+------+------+------+-------------|
  * | Alt  |  F11 |  F12 |     IME     |  TAB | SPC    SPC  ||||||||  BS     BS  | Enter|    RAISE    | Home |PageDn|  End |
  * ,----------------------------------------------------------------------------------------------------------------------.
  */
  [_RAISE] = LAYOUT(
    KC_GRV , KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_UNDS,                        KC_PLUS, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE,
    KC_TILD, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LCBR,                        KC_RCBR, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_COLN, KC_DQT ,
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SPC,                         KC_BSPC, KC_N,    KC_M,    KC_LT,   KC_GT,   KC_PGUP, KC_QUES,
    KC_LALT, KC_F11 , KC_F12,       IME,         KC_TAB,  KC_SPC, KC_SPC,        KC_BSPC, KC_BSPC, KC_ENT,     RAISE,        KC_HOME, KC_PGDN, KC_END
    ),
