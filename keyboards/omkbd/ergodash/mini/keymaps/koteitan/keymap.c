...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_LSFT, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_SPC,                  KC_BSPC, KC_N,    KC_M,    KC_LT,   KC_GT,   KC_PGUP, KC_BSLS,
    KC_LALT, KC_DEL,  KC_TAB,      RAISE,        IME,     KC_SPC, KC_SPC, KC_BSPC, KC_BSPC, KC_ENT,      LOWER,        KC_HOME, KC_PGDN, KC_END
  ),
  ...
  [_RAISE] = LAYOUT(
    ...
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SPC,                  KC_BSPC, KC_N,    KC_M,    KC_LT,   KC_GT,   KC_PGUP, KC_BSLS,
    KC_LALT, KC_F11 , KC_TAB,      RAISE,        IME,     KC_SPC, KC_SPC, KC_BSPC, KC_BSPC, KC_ENT,      LOWER,        KC_HOME, KC_PGDN, KC_END
  ),
